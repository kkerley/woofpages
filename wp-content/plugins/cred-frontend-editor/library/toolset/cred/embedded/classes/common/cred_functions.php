...
function cred_embedded_html() {
    ...
    text-decoration: none;" class="button button-primary-toolset" title="get cred" target="_blank" href="https://wp-types.com/home/toolset-components/?utm_source=credplugin&utm_campaign=cred&utm_medium=embedded-cred-promotional-link&utm_term=Get%20CRED#cred">Get CRED</a>';
            ...
            if ($notification->enable == 1 && count($notification->notifications) > 0) {
                ...
                foreach ($notification->notifications as $n => $notf) {
                    ...
                    if (count($notf['to']['type']) > 0) {
                        ...
                        //CRED_StaticClass::_pre($notf['to']['type']);
            ...
            <?php
            //CRED_StaticClass::_pre($form_fields['extra']);
            //CRED_StaticClass::_pre($cred);
            //CRED_StaticClass::_pre($settings);
            //CRED_StaticClass::_pre($fields_all);
        }
    } else {
