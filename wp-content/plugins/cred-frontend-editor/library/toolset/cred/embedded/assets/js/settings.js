...
Toolset_CRED.SettingsScreen = function( $ ) {
	...
	*/
	...
	$( document ).on( 'change', '.js-cred-styling-setting', function() {
	...
	self.save_cred_styling_options = function() {
		var data = $( '.js-toolset-forms-styling .js-cred-settings-wrapper input' ).serialize(),
	...
	self.cred_styling_options_debounce_update = _.debounce( self.save_cred_styling_options, 1000 );
