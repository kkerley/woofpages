                ...
                Actions: {
                    ...
                    'addItem': function ($el, data) {
                        ...
                        if (key && tmpl && container)
                        {
                            ...
                            //initialize quick tags for mail body editor
                            setTimeout(function(){
                                var quick = quicktags(tinyMCEPreInit.qtInit[item.find('textarea').attr('id')]);
                                Toolset.add_qt_editor_buttons(quick, item.find('textarea').attr('id'));
                                item.find('.switch-html').trigger('click');
                                setTimeout(function(){
                                    item.find('.switch-tmce').trigger('click');
                                }, 50);
                            }, 500);
