...
//            }
        ...
        popupHandler2: function (event)
        {
            ...
            if (mode.hasClass('cred-post-creation-container2'))
            {
                ...
                form_id = $('.cred_form-new-shortcode-select2', $parent).find('option:selected').attr('rel');
            ...
            else if (mode.hasClass('cred-user-creation-container2'))
            {
                ...
                form_id = $('.cred_user_form-new-shortcode-select2', $parent).find('option:selected').attr('rel');
    ...
    var self = {
        ...
        posts: function () {
            ...
            {
                var rel = $('.cred-form-shortcode-types-select-container2 .cred-post-creation-container2');
            ...
            {
                var rel = $('.cred-form-shortcode-types-select-container2 .cred-user-creation-container2');
                rel.prop('disabled', false);
            ...
            {
                var rel = $('.cred-form-shortcode-types-select-container2 .cred-user-edit-container2');
                rel.prop('disabled', false);
