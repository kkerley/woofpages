...
//        }
        ...
        add_action('admin_init', array(__CLASS__, 'initCREDButton'), 10);
        ...
        //Remove CRED button from form success message editor
        add_filter('toolset_cred_button_before_print', array('CRED_Helper', 'removeCREDButton'), 10, 2);
    }

    public static function initCREDButton(){
        CRED_Loader::load("CLASS/CRED_Editor_addon");
        if(class_exists("CRED_Editor_addon")){
            return new CRED_Editor_addon('cred',
                __( 'Insert Forms', "wp-cred" ),
                CRED_ASSETS_URL . '/js/post.js',
                '', true, ' ');
        }
    }
