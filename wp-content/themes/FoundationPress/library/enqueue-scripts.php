...
if ( ! function_exists( 'foundationpress_scripts' ) ) :
	function foundationpress_scripts() {
		...
		wp_enqueue_style( 'slick-css', get_template_directory_uri() . '/assets/javascript/vendor/slick/slick.css', array(), '1.6.0', 'all' );
		wp_enqueue_style( 'slick-theme-css', get_template_directory_uri() . '/assets/javascript/vendor/slick/slick-theme.css', array(), '1.6.0', 'all' );
		...
		wp_enqueue_script( 'app', get_template_directory_uri() . '/assets/javascript/app.js', array('slick-js'), '1.0', true );
